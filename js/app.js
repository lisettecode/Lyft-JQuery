...
var dropup = $(".dropup");                                                                  /* llamo a todos los dropdowns*/
if (dropup.length >=4) {                                         /*si la cantidad de dropdowns es igual o mayor a 4*/
    var dropchilds = $(".dropup:last").children();                     /*llamo a los hijos del ultimo dropdown*/
